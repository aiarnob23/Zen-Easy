      ...
      <div className="profile-wrapper">
        ...
        <div className="profile-header">
          ...
          <div className="profile-intro">
            <h1 className="profile-name">{userProfile?.name || "Unknown User"}</h1>
            <p className="profile-occupation">{userProfile?.occupation || "No occupation listed"}</p>
          </div>
          ...
          <button className="leave-review-btn"><Link to='/'>Leave A Review</Link></button>
            </div>
          }
        </div>
        ...
        <div className="profile-content">
            ...
            <div className="card-content">
              <div className="info-grid">
                <div className="info-item">
                  ...
                  <span className="info-value">{userProfile?.contactNumber || "Not provided"}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">WhatsApp</span>
                  <span className="info-value">{userProfile?.whatsapp || "Not provided"}</span>
                </div>
                <div className="info-item">
                ...
                <div className="info-item">
                  ...
                  <span className="info-value">{userProfile?.dateOfBirth || "Not provided"}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">Gender</span>
                  <span className="info-value">{userProfile?.gender || "Not specified"}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">Nationality</span>
                  <span className="info-value">{userProfile?.nationality || "Not specified"}</span>
                </div>
                ...
                <div className="social-section">
                  ...
                  <div className="social-links">
                    {userProfile.socialMedia.facebook && (
                      <Link to={userProfile.socialMedia.facebook} className="social-link facebook">
                    ...
                    {userProfile.socialMedia.instagram && (
                      <Link to={userProfile.socialMedia.instagram} className="social-link instagram">
                        <svg viewBox="0 0 24 24">
                    ...
                    {userProfile.socialMedia.linkedin && (
                      <Link to={userProfile.socialMedia.linkedin} className="social-link linkedin">
                        <svg viewBox="0 0 24 24">
          ...
          <div className="info-card professional-card">
            ...
            <div className="card-content">
              {userProfile?.professionalProfiles && userProfile.professionalProfiles.length > 0 ? (
                <div className="professional-profiles">
                  <h3>Professional Profiles</h3>
                  <div className="profiles-grid">
                    {userProfile.professionalProfiles.map((profession: string, index: number) => (
